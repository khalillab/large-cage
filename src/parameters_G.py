...
from large_cage.distributions import DistributionMixture as _DM
...
EGGS_WT = _DM(_eggs_wt[0],
              _eggs_wt[1])
EGGS_NUCL_FROM_MOTHER = _DM(_eggs_nucl_from_mother[0],
                            _eggs_nucl_from_mother[1])
EGGS_NUCL_FROM_FATHER = _DM(_eggs_nucl_from_father[0],
                            _eggs_nucl_from_father[1])
EGGS_NUCL_FROM_BOTH = _DM(_eggs_nucl_from_both[0],
